...
type Filter interface {
	Apply(providers []*Provider, policy *ConsumerPolicy) []*Provider
	Name() string
}
...
func (lf *LocationFilter) Apply(providers []*Provider, policy *ConsumerPolicy) []*Provider {
...
func (ff *FeatureFilter) Apply(providers []*Provider, policy *ConsumerPolicy) []*Provider {
...
func (ff *FeatureFilter) hasAllRequiredFeatures(provider *Provider, requiredFeatures []string) bool {
...
func (sf *StakeFilter) Apply(providers []*Provider, policy *ConsumerPolicy) []*Provider {
...
func (fc *FilterChain) ApplyFilters(providers []*Provider, policy *ConsumerPolicy) []*Provider {
	if len(providers) == 0 {
		return providers
	}
...
func (fc *FilterChain) GetFilterStats(providers []*Provider, policy *ConsumerPolicy) map[string]int {
...
func ValidatePolicy(policy *ConsumerPolicy) error {
	if policy == nil {
